...
String assetPath = 'assets/images/tencent1.mp4';
      ...
      body: ListView(
        children: <Widget>[
          ...
          ListTile(
            title: Text('file视频'),
            subtitle: Text(
              '（在/storage/emulated/0/test.mp4放对应视频，并打开文件读写权限）',
            ...
            onTap: () {
              Navigator.of(context).push(CupertinoPageRoute(
                  builder: (_) => FullVideoPage(
                        ...
                        dataSource: '/storage/emulated/0/test.mp4',
                      )));
            },
          ),
          ListTile(
          ...
          ListTile(
            ...
            onTap: () {
              Navigator.of(context)
                  .push(CupertinoPageRoute(builder: (_) => DownloadPage()));
            },
          ),
        ],
      ),
